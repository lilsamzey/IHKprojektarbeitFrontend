...
import { UntypedFormBuilder, UntypedFormGroup, Validators } from '@angular/forms';
  ...
  @Component({
    selector: 'app-studentattandence',
    templateUrl: './studentattandence.component.html',
    styleUrls: ['./studentattandence.component.scss']
  })


  export class StudentattandenceComponent implements OnInit {
  ...
  //search teacher variables
    ...
    constructor(
      public dialogRef: MatDialogRef<StudentattandenceComponent>,
    ...
    async studentDetails(row: Students) {
     ...
     await this.studentsService.getStudentUsersByStudentId(row.StudentId);
      ...
      const dialogRef = this.dialog.open(StudentattandenceComponent, {
        data: {
          student: row,
          action: 'edit',
        },
